...
public interface Codebase extends fabric.lang.Object {
  ...
  public static class _Proxy extends fabric.lang.Object._Proxy
    ...
    public native fabric.lang.FClass resolveClassName(java.lang.String arg1);
  ...
  public static class _Impl extends fabric.lang.Object._Impl
     ...
     *    the associated FClass, or null if there is none
     */
    public native fabric.lang.FClass resolveClassName(java.lang.String name);
    ...
    public void $serialize(java.io.ObjectOutput out, java.util.List refTypes,
      ...
      $writeRef($getStore(), this.classes, refTypes, out, intraStoreRefs,
          interStoreRefs);
      $writeRef($getStore(), this.codebases, refTypes, out, intraStoreRefs,
          interStoreRefs);
    }
    ...
    public _Impl(fabric.worker.Store store, long onum, int version,
      ...
      super(store, onum, version, observers, treaties, labelStore, labelOnum,
          ...
          interStoreRefs);
      this.classes = (fabric.util.Map) $readRef(fabric.util.Map._Proxy.class,
          (fabric.common.RefTypeEnum) refTypes.next(), in, store,
          intraStoreRefs, interStoreRefs);
      this.codebases = (fabric.util.Map) $readRef(fabric.util.Map._Proxy.class,
          (fabric.common.RefTypeEnum) refTypes.next(), in, store,
          intraStoreRefs, interStoreRefs);
    }
  ...
  interface _Static extends fabric.lang.Object, Cloneable {
    final class _Proxy extends fabric.lang.Object._Proxy
      ...
      static {
        fabric.lang.Codebase._Static._Impl impl =
            (fabric.lang.Codebase._Static._Impl) fabric.lang.Object._Static._Proxy
                .$makeStaticInstance(fabric.lang.Codebase._Static._Impl.class);

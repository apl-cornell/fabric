...
public interface Runtime extends fabric.lang.Object {
  ...
  public static class _Proxy extends fabric.lang.Object._Proxy
    ...
    public static native fabric.runtime.Runtime getRuntime(
        fabric.lang.security.Principal arg1) throws java.lang.SecurityException;

    public static native fabric.lang.security.Principal user(
        fabric.lang.security.Principal arg1);

    public native java.io.PrintStream stderr(fabric.lang.security.Label arg1);

    public native java.io.PrintStream stdout(fabric.lang.security.Label arg1);

    public native java.io.InputStream stdin(fabric.lang.security.Label arg1);
    ...
    public static native int currentYear(fabric.lang.security.Principal arg1);

    public static native int currentMonth(fabric.lang.security.Principal arg1);

    public static native int currentDayOfMonth(
        fabric.lang.security.Principal arg1);

    public static native int currentHour(fabric.lang.security.Principal arg1);

    public static native int currentMinute(fabric.lang.security.Principal arg1);

    public static native void sleep(fabric.lang.security.Principal arg1,
        int arg2);

    public _Proxy(Runtime._Impl impl) {
      super(impl);
    }
  ...
  public static class _Impl extends fabric.lang.Object._Impl
    ...
    public static native int currentYear(fabric.lang.security.Principal dummy);

    public static native int currentMonth(fabric.lang.security.Principal dummy);

    public static native int currentDayOfMonth(
        fabric.lang.security.Principal dummy);

    public static native int currentHour(fabric.lang.security.Principal dummy);
    ...
    public _Impl(fabric.worker.Store store, long onum, int version,
      ...
      super(store, onum, version, observers, treaties, labelStore, labelOnum,
          ...
          interStoreRefs);
      this.dynp = (fabric.lang.security.Principal) $readRef(
    ...
    public void $copyAppStateFrom(fabric.lang.Object._Impl other) {
      ...
      fabric.runtime.Runtime._Impl src = (fabric.runtime.Runtime._Impl) other;
      this.dynp = src.dynp;
  ...
  interface _Static extends fabric.lang.Object, Cloneable {
    ...
    final class _Proxy extends fabric.lang.Object._Proxy
      ...
      public boolean get$_nativeOK() {
        return ((fabric.runtime.Runtime._Static._Impl) fetch()).get$_nativeOK();
      }
      ...
      static {
        fabric.runtime.Runtime._Static._Impl impl =
            (fabric.runtime.Runtime._Static._Impl) fabric.lang.Object._Static._Proxy
                .$makeStaticInstance(

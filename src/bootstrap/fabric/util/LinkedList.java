...
public interface LinkedList
   ...
   */
     ...
     * @param index the initial index
     */
            public native LinkedListItr fabric$util$LinkedList$LinkedListItr$(int index);
   ...
   * @throws NullPointerException if c is null
   */
        public native fabric.util.LinkedList fabric$util$LinkedList$(fabric.util.Collection c);
   ...
   */
        private native void writeObject(java.io.ObjectOutputStream s) throws java.io.IOException;

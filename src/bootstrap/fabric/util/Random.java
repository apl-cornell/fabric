...
public interface Random extends java.io.Serializable, fabric.lang.Object {
  ...
  public static class _Proxy extends fabric.lang.Object._Proxy
    ...
    public boolean get$haveNextNextGaussian() {
      return ((fabric.util.Random._Impl) fetch()).get$haveNextNextGaussian();
    }

    public boolean set$haveNextNextGaussian(boolean val) {
      return ((fabric.util.Random._Impl) fetch()).set$haveNextNextGaussian(val);
    }
    ...
    public double set$nextNextGaussian(double val) {
      return ((fabric.util.Random._Impl) fetch()).set$nextNextGaussian(val);
    }

    public double postInc$nextNextGaussian() {
      return ((fabric.util.Random._Impl) fetch()).postInc$nextNextGaussian();
    }

    public double postDec$nextNextGaussian() {
      return ((fabric.util.Random._Impl) fetch()).postDec$nextNextGaussian();
    }
  ...
  interface _Static extends fabric.lang.Object, Cloneable {
    ...
    final class _Proxy extends fabric.lang.Object._Proxy
      ...
      static {
        fabric.util.Random._Static._Impl impl =
            (fabric.util.Random._Static._Impl) fabric.lang.Object._Static._Proxy

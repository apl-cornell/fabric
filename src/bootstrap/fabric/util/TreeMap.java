...
public interface TreeMap extends fabric.util.SortedMap, fabric.util.AbstractMap
{
   ...
   */
     ...
     * @param type {@link #KEYS}, {@link #VALUES}, or {@link #ENTRIES}
     */
            public native TreeIterator fabric$util$TreeMap$TreeIterator$(int type);
   ...
   *        for the natural order
   */
        public native fabric.util.TreeMap fabric$util$TreeMap$(fabric.util.Comparator c);
   ...
   * @see Comparable
   */
        public native fabric.util.TreeMap fabric$util$TreeMap$(fabric.util.Map map);
   ...
   * @throws IllegalArgumentException if fromKey is greater than toKey
   */
        public native fabric.util.SortedMap subMap(fabric.lang.Object fromKey, fabric.lang.Object toKey);
   ...
   * @throws NullPointerException if o1 or o2 is null with natural ordering
   */
        public final native int compare(fabric.lang.Object o1, fabric.lang.Object o2);
   ...
   * @return the next node
   */
        public final native Node lowestGreaterThan(fabric.lang.Object key, boolean first);
   ...
   * @see TreeSet#TreeSet(SortedSet)
   */
        public final native void putKeysLinear(fabric.util.Iterator keys, int count);

...
public interface TreeSet extends fabric.util.SortedSet, fabric.util.AbstractSet
{
   ...
   * @param comparator the Comparator this Set will use
   */
        public native fabric.util.TreeSet fabric$util$TreeSet$(fabric.util.Comparator comparator);
   ...
   * @see Comparable
   */
        public native fabric.util.TreeSet fabric$util$TreeSet$(fabric.util.Collection collection);
   ...
   * @throws NullPointerException if sortedSet is null
   */
        public native fabric.util.TreeSet fabric$util$TreeSet$(fabric.util.SortedSet sortedSet);
   ...
   */
        private native fabric.util.TreeSet fabric$util$TreeSet$(fabric.util.SortedMap backingMap);
   ...
   * @throws IllegalArgumentException if from is greater than to
   */
        public native fabric.util.SortedSet subSet(fabric.lang.Object from, fabric.lang.Object to);

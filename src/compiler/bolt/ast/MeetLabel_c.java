...
public class MeetLabel_c extends Label_c implements MeetLabel {
  ...
  public MeetLabel_c(Position pos, List<LabelComponent> components, Ext ext) {
    super(pos, null);
  ...
  @Override
  public MeetLabel components(List<LabelComponent> components) {
    return components(this, components);
  }

  protected <N extends MeetLabel_c> N components(N n,
  ...
  protected <N extends MeetLabel_c> N reconstruct(N n,
      List<LabelComponent> components) {

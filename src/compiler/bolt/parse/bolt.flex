...
%{
    ...
    protected void init_keywords() {
        ...
        keywords.put("actsFor",       sym.ACTSFOR);
        keywords.put("actsfor",       sym.ACTSFOR);
        keywords.put("equiv",         sym.EQUIV);
        keywords.put("label",         sym.LABEL);
        keywords.put("principal",     sym.PRINCIPAL);
        keywords.put("join",          sym.JOIN);
        keywords.put("meet",          sym.MEET);

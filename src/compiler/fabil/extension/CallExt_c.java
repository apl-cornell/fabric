...
public class CallExt_c extends ExprExt_c {
  ...
  public Expr rewriteProxiesImpl(ProxyRewriter pr) {
    ...
    if (call.name().equals("$getCore")) {
      // HACK: A static $getCore(). Assume this was generated by the compiler as
      // a default location and rewrite the call as a $getCore() on the static
      // instance object.
      newTarget =

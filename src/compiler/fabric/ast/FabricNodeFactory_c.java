...
public class FabricNodeFactory_c extends JifNodeFactory_c implements FabricNodeFactory {
  ...
  public FabricMethodDecl FabricMethodDecl(Position pos, Flags flags,
      TypeNode returnType, Id name, LabelNode startLabel,
      LabelNode beginConflictPolicy, List<Formal> arguments, LabelNode endLabel,
      LabelNode endConflictPolicy, List<TypeNode> exceptions,
    ...
    FabricMethodDecl n =
        new FabricMethodDecl_c(pos, flags, returnType, name, startLabel,
            beginConflictPolicy, arguments, endLabel, endConflictPolicy, exceptions,
  ...
  public FabricConstructorDecl FabricConstructorDecl(Position pos, Flags flags,
      Id name, LabelNode startLabel, LabelNode beginConflictPolicy,
      LabelNode returnLabel, List<Formal> arguments, LabelNode endConflictPolicy,
    ...
    FabricConstructorDecl n =
        new FabricConstructorDecl_c(pos, flags, name, startLabel,
            beginConflictPolicy, returnLabel, arguments, endConflictPolicy,

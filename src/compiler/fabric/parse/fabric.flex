...
%{
    ...
    protected void init_keywords() {
        ...
        keywords.put("actsFor",       Integer.valueOf(sym.ACTSFOR));
        keywords.put("actsfor",       Integer.valueOf(sym.ACTSFOR));
        keywords.put("equiv",         Integer.valueOf(sym.EQUIV));
        keywords.put("authority",     Integer.valueOf(sym.AUTHORITY));
        keywords.put("caller",        Integer.valueOf(sym.CALLER));
//      keywords.put("covariant",     Integer.valueOf(sym.COVARIANT));
        keywords.put("invariant",     Integer.valueOf(sym.INVARIANT));
        keywords.put("declassify",    Integer.valueOf(sym.DECLASSIFY));
        keywords.put("endorse",       Integer.valueOf(sym.ENDORSE));
        keywords.put("to",            Integer.valueOf(sym.TO));
        keywords.put("label",         Integer.valueOf(sym.LABEL));
        keywords.put("principal",     Integer.valueOf(sym.PRINCIPAL));
        keywords.put("where",         Integer.valueOf(sym.WHERE));
        keywords.put("meet",          Integer.valueOf(sym.MEET));
        
        keywords.put("provider",     Integer.valueOf(sym.PROVIDER));        

        /* Fabric-specific keywords */
        keywords.put("atomic",        Integer.valueOf(sym.ATOMIC));
        keywords.put("worker$",       Integer.valueOf(sym.WORKER));
       	keywords.put("store$",       Integer.valueOf(sym.STORE));        
        keywords.put("nonfabric",     Integer.valueOf(sym.NONFABRIC));
        keywords.put("codebase",     Integer.valueOf(sym.CODEBASE));        
    }

...
extends ActsForProof<Superior, Inferior> {
  ...
  public TransitiveProof(ActsForProof<Superior, Intermediate> superiorToP,
    ...
    super(superiorToP.superior, pToInferior.inferior, superiorToP.label,
        superiorToP.accessPolicy);

    this.superiorToP = superiorToP;
    this.pToInferior = pToInferior;
    this.p = p;

    assertEquals(superiorToP.label, pToInferior.label);
    assertEquals(superiorToP.accessPolicy, pToInferior.accessPolicy);
  }
}

 ...
 * @author mdgeorge
 */
public class SubServerSocketFactory implements fabric.common.net.ServerSocketFactory<SubServerSocket,SubServerSocketFactory,SubSocket,SubSocketFactory> {

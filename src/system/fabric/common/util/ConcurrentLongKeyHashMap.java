...
public class ConcurrentLongKeyHashMap<V> extends AbstractLongKeyMap<V>
  ...
  public <T extends V> void putAll(LongKeyMap<T> m) {
    for (LongKeyMap.Entry<? extends V> e : m.entrySet())
  ...
  public Set<LongKeyMap.Entry<V>> entrySet() {
    Set<LongKeyMap.Entry<V>> es = entrySet;
   ...
   */
  final class WriteThroughEntry extends AbstractLongKeyMap.SimpleEntry<V> {
    ...
    public V setValue(V value) {
      ...
      ConcurrentLongKeyHashMap.this.put(getKey(), value);
      return v;
    }
  }
  ...
  final class EntryIterator extends HashIterator implements Iterator<Entry<V>> {
    @Override
    public LongKeyMap.Entry<V> next() {
  ...
  final class KeySet extends AbstractLongSet {
    ...
    public boolean remove(long o) {
      return ConcurrentLongKeyHashMap.this.remove(o) != null;
    }

    @Override
    public void clear() {
      ConcurrentLongKeyHashMap.this.clear();
    }
  }
  ...
  final class Values extends AbstractCollection<V> {
    ...
    public boolean contains(Object o) {
      return ConcurrentLongKeyHashMap.this.containsValue(o);
    }
  ...
  final class EntrySet extends AbstractSet<LongKeyMap.Entry<V>> {
    @Override
    ...
    public boolean contains(Object o) {
      ...
      V v = ConcurrentLongKeyHashMap.this.get(e.getKey());

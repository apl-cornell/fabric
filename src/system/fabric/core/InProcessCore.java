...
public class InProcessCore extends RemoteCore {
  ...
  public void prepareTransaction(long tid, long commitTime, Collection<$Impl> toCreate,
    ...
    PrepareRequest req =
        new PrepareRequest(tid, commitTime, serializedCreates, serializedWrites, reads);
  ...
  public ObjectGroup readObjectFromCore(long onum) throws FetchException {
    try {
      ...
      SerializedObject obj = tm.checkRead(Client.getClient().getPrincipal(), onum);
      map.put(onum, obj);

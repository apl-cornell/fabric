...
extends
Message<BeginTransactionMessage.Response, TransactionBeginFailedException> {
  // ////////////////////////////////////////////////////////////////////////////
  // message contents //
  // ////////////////////////////////////////////////////////////////////////////
   ...
   */
  public BeginTransactionMessage(long tid, long commitTime) {
  ...
  public BeginTransactionMessage(long tid, long commitTime,
    ...
    super(MessageType.BEGIN_TRANSACTION,
        TransactionBeginFailedException.class);
  ...
  public static class Response implements Message.Response {
     ...
     */
    public final boolean transactionBegun;
    ...
    public Response(boolean transactionBegun) {
      this.transactionBegun = transactionBegun;
    }
  }
  ...
  /* readMessage */
  protected BeginTransactionMessage(DataInput in) throws IOException {
  ...
  protected void writeResponse(DataOutput out, Response r) throws IOException {
    out.writeBoolean(r.transactionBegun);
  }

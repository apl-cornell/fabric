...
public final class LocalCore implements Core {
  ...
  private static final Logger log = Logger.getLogger("fabric.worker.LocalCore");
  ...
  /**
   * The singleton LocalCore object is managed by the Worker class.
   * 
   * @see fabric.worker.Worker.getLocalCore
   */
  protected LocalCore() {
  }
  ...
  public void initialize() {
    ...
    Worker.runInSubTransaction(new Worker.Code<Void>() {
      ...
      public Void run() {
        ...
        ConfPolicy conf =
            LabelUtil._Impl.readerPolicy(LocalCore.this, workerPrincipal,
                (Principal) null);
        IntegPolicy integ =
            LabelUtil._Impl.writerPolicy(LocalCore.this, workerPrincipal,
                (Principal) null);

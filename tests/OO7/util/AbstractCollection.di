/*
 * @(#)AbstractCollection.java 1.38 06/06/16 Copyright 2006 Sun Microsystems,
...
public abstract class AbstractCollection implements Collection {
   ...
   * The {@code size} method is called only as an optimization hint; the correct
...
//    int size = size();
//    Object[] r =
//        a.length >= size ? a : (Object[]) java.lang.reflect.Array.newInstance(a
...
//   * they are returned by its iterator, enclosed in square brackets (<tt>"[]"</tt>).

/*
 * @(#)AbstractSequentialList.java 1.36 06/04/21 Copyright 2006 Sun
 ...
 * by a "sequential access" data store (such as a linked list). For random
 * access data (such as an array), <tt>AbstractList</tt> should be used in
 * preference to this class.
 * <p>
 * This class is the opposite of the <tt>AbstractList</tt> class in the sense
 * that it implements the "random access" methods (<tt>get(int index)</tt>,
 * <tt>set(int index, E element)</tt>, <tt>add(int index, E element)</tt>
 * and <tt>remove(int index)</tt>) on top of the list's list iterator,
...
public abstract class AbstractSequentialList extends AbstractList {
   ...
   * <p>
   * This implementation first gets a list iterator pointing to the indexed
   * element (with <tt>listIterator(index)</tt>). Then, it removes the
   * element with <tt>ListIterator.remove</tt>.
   * <p>
   * Note that this implementation will throw an
   * <tt>UnsupportedOperationException</tt> if the list iterator does not

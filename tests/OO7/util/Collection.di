/*
 * @(#)Collection.java 1.55 06/04/21 Copyright 2006 Sun Microsystems, Inc. All
 ...
 * others unordered. The JDK does not provide any <i>direct</i> implementations
 * of this interface: it provides implementations of more specific subinterfaces
 * like <tt>Set</tt> and <tt>List</tt>. This interface is typically used to
 ...
 * insertion of an ineligible element into the collection may throw an exception
 ...
 * <tt>Collection.contains</tt> with a non-null argument <tt>o</tt> will
 * cause <tt>o.equals(e)</tt> to be invoked for any element <tt>e</tt>.
...
//   * (This is useful in determining the length of this collection <i>only</i>
//   * if the caller knows that this collection does not contain any <tt>null</tt>
//   * elements.)
//   * <p>
...
//  Object[] toArray(Object[] a);
   ...
   *           and this collection does not permit null elements (optional), or

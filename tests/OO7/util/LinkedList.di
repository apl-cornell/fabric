/*
 * @(#)LinkedList.java 1.67 06/04/21 Copyright 2006 Sun Microsystems, Inc. All
 ...
 * <tt>remove</tt> and <tt>insert</tt> an element at the beginning and end
 ...
 * first-in-first-out queue operations for <tt>add</tt>, <tt>poll</tt>,
 ...
 * some object that naturally encapsulates the list. If no such object exists,
 * the list should be "wrapped" using the
...
public class LinkedList extends AbstractSequentialList implements List {
   ...
   * of <tt>List.listIterator(int)</tt>.
   * <p>
  ...
  Entry addBefore(Object e, Entry entry) {

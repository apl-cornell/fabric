/*
 * @(#)List.java 1.49 06/04/21 Copyright 2006 Sun Microsystems, Inc. All rights
 ...
 * and <tt>hashCode</tt> methods. Declarations for other inherited methods are
 ...
 * implementations (the <tt>LinkedList</tt> class, for example). Thus,
 ...
 * to query the presence of an ineligible element may throw an exception, or it
 * may simply return false; some implementations will exhibit the former
 * behavior and some will exhibit the latter. More generally, attempting an
 * operation on an ineligible element whose completion would not result in the
 * insertion of an ineligible element into the list may throw an exception or it
 * may succeed, at the option of the implementation. Such exceptions are marked
 * as "optional" in the specification for this interface.
 * <p>
...
//   * following the end of the list is set to <tt>null</tt>. (This is useful
...
//  Object[] toArray(Object[] a);
   ...
   *           null elements (optional)
   * @throws UnsupportedOperationException
   *           if the <tt>remove</tt> operation is not supported by this list
   */
   ...
   *           are incompatible with this list (optional)
   * @throws NullPointerException
   *           if the specified collection contains one or more null elements
   *           and this list does not permit null elements (optional), or if the
   ...
   * @throws UnsupportedOperationException
   *           if the <tt>addAll</tt> operation is not supported by this list
   * @throws ClassCastException
   *           if the class of an element of the specified collection prevents
   *           it from being added to this list
   * @throws NullPointerException
   *           if the specified collection contains one or more null elements
   *           and this list does not permit null elements, or if the specified
   *           collection is null
   * @throws IllegalArgumentException
   ...
   * two lists are <i>equal</i>. (Two elements <tt>e1</tt> and <tt>e2</tt>
   * are <i>equal</i> if <tt>(e1==null ? e2==null :
   * e1.equals(e2))</tt>.) In
   ...
   * works properly across different implementations of the <tt>List</tt>
   * interface.
   * 
   * @param o
   ...
   * <tt>list1</tt> and <tt>list2</tt>, as required by the general contract
   ...
   * @throws IndexOutOfBoundsException
   *           for an illegal endpoint index value (<tt>fromIndex &lt; 0 || toIndex &gt; size ||

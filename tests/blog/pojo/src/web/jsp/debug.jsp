...
<%@ page import="webapp.blog.Statistics" %>
...
<p><b>Number of blogs:</b> ${fn:length(blog.blogPosts)}<br />
<b>Number of comments:</b> ${fn:length(blog.comments)}</p>
</td>
<td valign="top">
<h2>Actions</h2>
...
<h2>Workers</h2>
<ul>
<c:forEach var="entry" items="${workers}">

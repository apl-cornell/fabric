...
if(debug)
{
  Element debugids= (Element) root.getElementsByTagName(XMLBuilder.$Static.$Proxy.$instance.get$TAG_DEBUGIDS()).item(0);
  if(debugids == null)
  { %>
...
<%}
	else
	{
	  ...
	  for (int i= 0; i != l.getLength(); i++)
	  {
	    ...
	    String debugid= id.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_DEBUGID()); %>

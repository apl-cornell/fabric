...
Element students= XMLUtil.$Proxy.getFirstChildByTagName(root, XMLBuilder.$Static.$Proxy.$instance.get$TAG_STUDENTS());
Element assignments= XMLUtil.$Proxy.getFirstChildByTagName(course, XMLBuilder.$Static.$Proxy.$instance.get$TAG_ASSIGNMENTS());
String courseid= course.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_COURSEID());
boolean hasSection = course.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_HASSECTION());
boolean isadmin= course.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_ISADMIN());
boolean isgroups= course.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_ISGROUPS());
boolean isgrades= course.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_ISGRADES());
boolean isassign= course.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_ISASSIGN());
boolean showAddDrop= root.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_SHOWADDDROP());
boolean showGradeMsg = root.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_GRADEMSG());%>
...
for (int i= 0; i != assigns.getLength(); i++) {
  ...
  int type = assign.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_ASSIGNTYPE()) ? Integer.parseInt(assign.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_ASSIGNTYPE())) : -1;
  if (type == Assignment.$Static.$Proxy.$instance.get$SURVEY()) continue;
  %>
...
if (isadmin || isgrades || isgroups) {
    begingrade= assignactbegin1 + AccessController.ACT_GRADEASSIGN + assignactbegin2 + assign.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_ID()) + assignactbegin3;
...
%>
<%=begingrade%>
<%= assign.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_NAMESHORT()) %>
<%=endgrade%>
</th><%
} %>
...
{
	Element assign= (Element)assigns.item(i);
	String total = assign.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_TOTALSCORE()),   
      mean = assign.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_STATMEAN()) ? assign.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_STATMEAN()) : "", 
      max = assign.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_STATMAX()) ? assign.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_STATMAX()) : "", 
      median = assign.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_STATMEDIAN()) ? assign.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_STATMEDIAN()) : "", 
      dev = assign.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_STATDEV()) ? assign.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_STATDEV()) : "",
      weight = assign.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_WEIGHT()) ? assign.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_WEIGHT()) : "",
      nameShort= assign.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_NAMESHORT()) ? " ("+assign.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_NAMESHORT())+")" : "",
      nameAssign= assign.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_NAME()) ? assign.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_NAME()) : "";
	  int type = assign.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_ASSIGNTYPE()) ? Integer.parseInt(assign.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_ASSIGNTYPE())) : -1;
	  if (type == Assignment.$Static.$Proxy.$instance.get$SURVEY()) continue;
%>
              ...
              <th class="nosort" align="center">
              	<div onMouseover="ddrivetip('<b>Max:</b> <%= course.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_MAXTOTALSCORE()) %><br><b>High:</b> <%= course.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_HIGHTOTALSCORE()) %><br><b>Mean:</b> <%= course.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_MEANTOTALSCORE()) %><br><b>Median:</b> <%= course.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_MEDIANTOTALSCORE()) %><br><b>Dev:</b> <%= course.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_STDEVTOTALSCORE()) %>');" onMouseout="hideddrivetip()">
              	<div style="display:none">~</div>  <center><small> <u>Stats</u> </small></center></div>
              </th>
              <th class="nosort"><div style="display:none">~</div>&nbsp;</th>
              <th class="nosort"><div style="display:none">~</div>&nbsp;</th>
            </tr><%
NodeList studs= XMLUtil.$Proxy.getChildrenByAttributeValue(students, XMLBuilder.$Static.$Proxy.$instance.get$A_ENROLLED(), Student.$Static.$Proxy.$instance.get$ENROLLED());
...
for (int i= 0; i < studs.getLength(); i++) {
  ...
  String hiddenAppend= "<span style=\"display: none;\">"+","+student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_LASTNAME())+","+student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_FIRSTNAME())+","+student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_NETID())+"</span>";
  String totalscore= student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_TOTALSCORE()); 
  String netID = student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_NETID()); 
  String section = student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_SECTION());
...
<%-- ----------------------------------- begin row --------------------------------------------------------- --%>
            ...
            <td nowrap class="index"><%= i + 1 %></td>
              <td><%= student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_LASTNAME())%><%=hiddenAppend%></td>
              <td><%= student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_FIRSTNAME())%><%=hiddenAppend%></td>
              <td>
...
<%
  for (int j= 0; j != assigns.getLength(); j++) {
    ...
    String assignTag= "id"+assign.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_ASSIGNID());
    Element grade= (Element)student.getElementsByTagName(assignTag).item(0);
    String score= "*";
    if(grade != null && grade.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_SCORE())) score= grade.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_SCORE());
    String assignID=grade.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_ASSIGNID());
    String groupID=grade.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_GROUPID());
    String regradeStatus = grade.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_REGRADE());
	boolean overMaxScore = grade.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_OVERMAX());
  	int type = assign.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_ASSIGNTYPE()) ? Integer.parseInt(assign.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_ASSIGNTYPE())) : -1;     
    if (type == Assignment.$Static.$Proxy.$instance.get$SURVEY()) continue;
%>
              <%-- The next line is real long, but don't split it up
                ...
                --%>
              <td nowrap align="right" <%= regradeStatus.equals(RegradeRequest.$Static.$Proxy.$instance.get$PENDING()) ? "class=\"regrade_pending\"" : (regradeStatus.equals(RegradeRequest.$Static.$Proxy.$instance.get$REGRADED()) ? "class=\"regraded\"" : "") %>><%=overMaxScore ? "<img src=\"images/warning.gif\" height=\"15px\" alt=\"(Over Max Score)\">" : ""%>
				<% if (isadmin) { %>
...
<%
         ...
         <% String finalGrade = student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_FINALGRADE()); 
	...
	<%=hiddenAppend%>
                <select name="<%= AccessController.P_FINALGRADE + student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_NETID()) %>" id="<%= AccessController.P_FINALGRADE + student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_NETID()) %>"<%= isadmin ? "" : " disabled" %>>
...
for (int i= 0; i != assigns.getLength(); i++) {
  Element assign= (Element)assigns.item(i); %>
              <th class="scores"><%= assign.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_NAMESHORT()) %></th><%
} %>
              <th class="scores">Total</th>
              <th id="finalgrade" class="nosort">Final Grade</th>
              <th class="nosort">&nbsp;</th>
            </tr><%
studs= XMLUtil.$Proxy.getChildrenByAttributeValue(students, XMLBuilder.$Static.$Proxy.$instance.get$A_ENROLLED(), Student.$Static.$Proxy.$instance.get$DROPPED());
for (int i= 0; i < studs.getLength(); i++) {
  Element student= (Element) studs.item(i); 
  /* hidden append for second sort by */
  String hiddenAppend= "<div style=\"display: none;\">"+","+student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_LASTNAME())+","+student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_FIRSTNAME())+","+student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_NETID())+"</div>";
  String totalscore= student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_TOTALSCORE()); 
  String netID = student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_NETID());
%>
           <tr>
  ...
  for (int j= 0; j != assigns.getLength(); j++) {
    ...
    if (grade != null)
    {
    	score = (grade.hasAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_SCORE())) ? grade.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_SCORE()) : "*";
    	assignID= grade.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_ASSIGNID());
    	groupID= grade.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_GROUPID());
    }
     %>
              <%-- The next line is real long, but don't split it up 
                   or the sorttable will break
...
<%
              ...
              <td align="center"><% if (totalscore.equals("")) { %><%=hiddenAppend%>*<% } else {%><%=totalscore %><%=hiddenAppend%><% } %></td>
              <td class="finalgrade" align="center">
                <%-- <input type="text" size="2" name="<%= AccessController.P_FINALGRADE + student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_NETID()) %>" value="<%= student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_FINALGRADE()) %>"> --%>
                <select name="<%= AccessController.P_FINALGRADE + student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_NETID()) %>" id="<%= AccessController.P_FINALGRADE + student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_NETID()) %>" disabled="true">
                  <% String finalGrade = student.getAttribute(XMLBuilder.$Static.$Proxy.$instance.get$A_FINALGRADE()); %>
                  <option value="null"<%= finalGrade.equals("") ? " selected" : "" %>></option>
                  <option value="A+"<%= finalGrade.equals("A+") ? " selected" : "" %>>A+</option>
                  <option value="A"<%= finalGrade.equals("A") ? " selected" : "" %>>A</option>
